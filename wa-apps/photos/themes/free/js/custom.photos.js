( function($, waTheme) { "use strict";
    ...
    var PhotoList = ( function($) {
        ...
        PhotoList.prototype.initWookmark = function() {
            var that = this,
                $list = that.$wrapper.find(".p-photo-list"),
                options = {
                    offset: 0,
                    outerOffset: 0,
                    container: $list,
            ...
            that.wookmark = new Wookmark($list[0], options);
    ...
    var PhotoPage = ( function($) {
        ...
        PhotoPage.prototype.initClass = function() {
            var that = this;
    ...
    waTheme.init.photos.PhotoList = PhotoList;
    waTheme.init.photos.PhotoPage = PhotoPage;
